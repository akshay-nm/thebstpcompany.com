...
const Home = () => {
  return (
    <div className='w-full flex flex-col p-10 mt-40 relative'>
      <div className='text-5xl md:text-6xl font-heading text-button-primary'>Tell your story <br />the right way</div>
      ...
      <div className='pt-10'>
        <button className='bg-button-primary hover:bg-button-dark text-primary font-bold py-2 px-4 rounded-full'>Book your consultation now</button>
      </div>
