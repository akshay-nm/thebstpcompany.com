    ...
    <div className='p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-gray-900 text-white'>
      <div className='flex flex-col items-center text-center p-4 mb-6'>
        <div className='border rounded-lg h-48'>
          <img src={badge} className='object-scale-down h-full w-full' />
        </div>
      ...
      <div className='flex flex-col items-center text-center p-4 mb-6'>
        <div className='border rounded-lg h-48'>
          <img src={stopwatch} className='object-scale-down h-full w-full' />
        </div>
      ...
      <div className='flex flex-col items-center text-center p-4 mb-6'>
        <div className='border rounded-lg h-48'>
          <img src={magnifyingGlass} className='object-scale-down h-full w-full' />
        </div>
      ...
      <div className='flex flex-col items-center text-center p-4'>
        <div className='border rounded-lg h-48'>
          <img src={handshake} className='object-scale-down h-full w-full' />
        </div>
