...
const Pricing = () => {
  return (
    <div className='px-16 py-32 bg-primary'>
      <div className='text-center text-5xl mb-5 font-heading text-button-primary lg:text-pricing-header'>Pricing</div>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 p-5 text-pricing-content'>
        <div className='flex items-center justify-center'>
          <div className='flex flex-col bg-button-primary rounded-lg p-1 w-full max-w-xs'>
            ...
            <div className='text-center rounded-lg bg-primary p-4 text-button-primary'>
              <div className='text-2xl font-heading text-pricing-sub-header'>Small</div>
              ...
              <div className='text-pricing-content-bold'>$39.00 / month</div>
              <button className='bg-button-primary hover:bg-gray-700 text-primary text-pricing-content-bold font-bold py-2 px-4 mt-4 rounded-full'>Buy Now</button>
            </div>
          </div>
        </div>
        ...
        <div className='flex items-center justify-center'>
          <div className='flex flex-col bg-button-primary rounded-lg p-1 w-full max-w-xs'>
            ...
            <div className='text-center rounded-lg bg-primary p-4 text-button-primary'>
              <div className='text-2xl font-heading text-pricing-sub-header'>Medium</div>
              <div>Articles per Month - 4</div>
              <div>Articles per Week - 1</div>
              <div>Words per article - 300</div>
              <div>SEO Keyword Writing - Yes</div>
        ...
        <div className='flex items-center justify-center'>
          <div className='flex flex-col bg-button-primary rounded-lg p-1 w-full max-w-xs'>
            <div className='h-32 bg-button-primary overflow-hidden'>
              <img src={lgCat} className='h-full w-full mt-10' alt='too many cats' />
            </div>
            <div className='text-center rounded-lg bg-primary p-4 text-button-primary'>
              ...
              <div>Posting Included - No</div>
              <div className='text-pricing-content-bold'>$39.00 / month</div>
              <button className='bg-button-primary hover:bg-gray-700 text-primary  font-bold py-2 px-4 mt-4 rounded-full'>Buy Now</button>
            </div>
          </div>
        </div>
      </div>
